...
const QString CONTACT_INFO = "<html><head/><body><p>Nick Lalic<br/>VNA Software Developer<br/>San Francisco, CA USA<br/>+1 424 200 2846<br/>nick.lalic@rsa.rohde-schwarz.com<br/><a href=\"http://vna.rs-us.net\"><span style=\"text-decoration: underline; color:#0000ff;\">http://vna.rs-us.net</span></a></p></body></html>";

// Connection settings
const unsigned int TIMEOUT_MS = 1000;
#ifdef DEBUG_MODE
    const RsaToolbox::ConnectionType CONNECTION_TYPE     = RsaToolbox::ConnectionType::VisaGpibConnection;
    const QString                    INSTRUMENT_ADDRESS  = "10";

    const RsaToolbox::ConnectionType DMM_CONNECTION_TYPE = RsaToolbox::ConnectionType::VisaGpibConnection;
    const QString                    DMM_ADDRESS         = "11";
